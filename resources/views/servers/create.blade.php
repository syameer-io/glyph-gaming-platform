    ...
    <div class="container" style="max-width: 600px;">
        <div class="auth-box" style="margin-top: 48px;">
            ...
            <form method="POST" action="{{ route('server.store') }}">
                ...
                <div style="margin-top: 32px; padding: 16px; background-color: var(--color-bg-primary); border-radius: 8px;">
                    <p style="font-size: 14px; color: var(--color-text-secondary); margin-bottom: 8px;">
                        <strong style="color: var(--color-text-primary);">When you create this server:</strong>
                    </p>
