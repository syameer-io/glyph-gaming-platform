...
<main>
    <div class="container">
        <div style="text-align: center; padding: 80px 20px;">
            ...
            <h2 style="font-size: 24px; font-weight: 600; margin-bottom: 12px; color: #fafafa;">This Profile is Private</h2>
            <p style="color: #a1a1aa; max-width: 400px; margin: 0 auto 24px;">
